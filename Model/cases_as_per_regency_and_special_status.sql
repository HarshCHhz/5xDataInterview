...
sum(new_cases) daily_new_case,sum(new_deaths) daily_new_deaths,sum(NEW_RECOVERED) daily_new_recovery,sum(total_cases) as total_case_reported,
sum(total_deaths) as total_death_reported
from 
